...
// Imports
import { faCheck, faChevronDown, faEdit, faRedo, faTimes } from "@fortawesome/free-solid-svg-icons";
...
export default function Event_item_full(props) {
    ...
    // Title string maintains a temporary backup of the title
    ...
    function edit_event(new_title, new_desc, new_priority, new_due_date) {
        ...
        // Opens a request to the database
    ...
    function show_description(e) {
        ...
        // Changes the class to show the description
    ...
    function show_hide_group(e) {
        ...
        // If the group component is currently not hidden shows the group
        if (event_group.classList.contains('hide_event_group') === false) {
            ...
            // When the transition ends, shows the group
