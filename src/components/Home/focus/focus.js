...
export default class Focus extends React.Component {
    ...
    render() {
        ...
        function focus_help() {
            ...
            create_modal(modal_width, true, modal_content, true, false);
        }
...
export function Add_new_step() {
    ...
    if (steps_list.length < 20) {
        if (document.querySelector('#current_focus').classList.contains('focus_tutorial') === false) {
            ...
            create_modal(width, true, content, true, false);
            title.focus();
...
export function check_focus() {
    ...
    if (focus_from_database === null || focus_from_database === undefined) {
        ...
        if (button.parentNode.querySelectorAll('.delete_button').length === 0) {
            console.log(focus_from_database)
            console.log('hello')
